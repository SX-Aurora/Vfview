...
/*
 * @(#)ViewerFileView.java	1.7 99/04/23
 *
 ...
 * @author Jeff Dinkins
 */
public class ViewerFileView extends FileView {
     ...
     *
     * You might want to subtype ViewerFileView to do something more interesting,
